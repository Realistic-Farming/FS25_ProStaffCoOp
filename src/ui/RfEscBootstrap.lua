-- =========================================================
-- Realistic Farming Esc - equal shared chrome bootstrap (NO HOST)
-- =========================================================
...
--- Inject frame into InGameMenu (WC/Soil port of addIngameMenuPage; vendored into Pro Staff BUILD 00:46).
...
---@param modDir string (ProStaffCoOpModDirectory or g_currentModDirectory) of the calling joiner
